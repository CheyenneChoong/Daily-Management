...
class Notification(QWidget) :
    ...
    def _overview(self):
        ...
        _tasks = _cursor.execute(f"SELECT COUNT(executeDate) FROM tasks WHERE (completionDate = '{QDate.toString(QDate.currentDate(), "d/M/yyyy")}' OR status = 'pending') AND executeDate = '{QDate.toString(QDate.currentDate(), "d/M/yyyy")}';")
